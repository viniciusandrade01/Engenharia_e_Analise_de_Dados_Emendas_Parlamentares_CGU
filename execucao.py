...
def main():
    try:
        ...
        webPageDataScrapers.extractZip(html, "EmendasParlamentares.zip", directory_name)
        logging.info("INFORMAÇÕES DO ARQUIVO BAIXADA COM SUCESSO.")
        #zip_file = webPageDataScrapers.readZipFile(jsonData['source']['generalLink']['url'], directory_name)
