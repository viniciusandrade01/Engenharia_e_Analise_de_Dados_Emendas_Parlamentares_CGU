...
class TransformData:
    ...
    def getFileName(self, jsonData: dict):
            return f"{jsonData['source']['generalLink']['params']['namefile']}{jsonData['source']['generalLink']['params']['year']}{jsonData['source']['generalLink']['params']['month']}" if jsonData['source']['generalLink']['params']['year'] != '' else f"{jsonData['source']['generalLink']['params']['namefile']}Historico"
